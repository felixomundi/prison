                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-8 col-lg-6 col-xl-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="<?php echo htmlentities($result1->f_name);?>" class="form-control" name="f_name" required="true" id="cell_name">
                                                        ...
                                                        <div class="col-md-8 col-lg-6 col-xl-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="<?php echo htmlentities($result1->m_name);?>" class="form-control" name="m_name" required="true" id="cell_name">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-8 col-lg-6 col-xl-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="<?php echo htmlentities($result1->l_name);?>" name="l_name" class="form-control" required="true" id="cell_name">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-8 col-lg-6 col-xl-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control"  name="prisoner_id" required="true">
