...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_REQUEST['append'])) {
        ...
        $sql = "UPDATE `users` SET `status`=0 WHERE id=:dd";
        $query = $dbh->prepare($sql);
        $query->bindParam(':dd', $dd, PDO::PARAM_STR);
        $query->execute();
        echo "<script>alert('User Appended');document.location = 'manage-users.php';</script>";
    }
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <h3 class="text-dark mb-4">Users</h3><a href="add-user.php" id="create_new" align="right" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>Add New Staff</a>
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 font-weight-bold">Active Staff</p>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                            ...
                                            foreach ($results as $result) {
                                              //  $name = htmlentities($result->fname . " " . $result->lname); ?>
                                                <tr>
                                                    ...
                                                    <td><a href="manage-users.php?append=<?php echo $result->id; ?>"
                                                           onclick="return confirm('Do you want to append?');">append</a>
                                                    </td>
                                                </tr>
                                                <?php $cnt = $cnt + 1;
                                            }
                        ...
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 font-weight-bold">Disapproved Staff</p>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 text-nowrap">
