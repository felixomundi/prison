...
$sql="update prisoners set profilepic=:vimage1 where id=:id";
$query = $dbh->prepare($sql);
$query->bindParam(':vimage1',$vimage1,PDO::PARAM_STR);
$query->bindParam(':id',$id,PDO::PARAM_STR);
$query->execute();

$msg="Prisoner Image updated successfully";
...
<head>
	...
	<title>Update Prisoner  Profile</title>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Current Prisoner Profile Image</label>
<?php 
$id=intval($_GET['userid']);
$sql ="SELECT profilepic from prisoners where prisoners.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
